...
Transactions were then classified into:

High Risk → Immediate review or investigation
Medium Risk → Additional verification checks
Low Risk → Minimal intervention required

This approach demonstrates how investigation insights can be translated into practical fraud monitoring strategies.
